...
Original file is located at
    https://colab.research.google.com/drive/1kTPBOEDZZiV55tYCb0lICkYl-rw1K0al
...
model.compile(optimizer=Adam(learning_rate=0.01, beta_1=0.9, beta_2=0.999), loss='categorical_crossentropy')
...
"""##Check our model to decode the input sequence"""
